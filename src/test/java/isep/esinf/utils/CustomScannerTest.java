...
public class CustomScannerTest {
  private static final String CSV_FILE_PATH = "./src/test/java/isep/esinf/data/test.csv";
  private static final String TXT_FILE_PATH = "./src/test/java/isep/esinf/data/scanner.txt";
